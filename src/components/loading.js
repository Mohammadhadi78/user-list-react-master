...
export default function Modal() {
    ...
    //
    const loadingValue = useSelector(state => state.loadingModal.value)

    return (
        <Transition.Root show={loadingValue} as={Fragment}>
            <Dialog as="div" className="fixed z-10 inset-0 overflow-y-auto" onClose={reduxShowLoading}>
