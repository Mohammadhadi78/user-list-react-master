                            ...
                            <table className="min-w-full divide-y divide-gray-300">
                                ...
                                <tbody className="divide-y divide-gray-200 bg-white">
                                {
                                    ...
                                    finalUserList.length
                                        ? finalUserList.map((user,index) => <UserListItem key={user.id}
                                            user={user}
                                            index={index}
                                            deleteUserHandler={deleteUserHandler}
                                            getTargetUserHandler={getTargetUserHandler}
                                        />)
                                        : <tr><td className="my-5 mx-4">کاربری برای نمایش وجود ندارد</td></tr>
                                        // : <span> className="my-5 mx-4">کاربری برای نمایش وجود ندارد</span>
                                }
                                </tbody>
                            </table>
                        </div>
